...
public class MainActivity extends FragmentActivity implements
	...
	public void loadBulletins(View view) {
		LinearLayout layout = (LinearLayout)this.findViewById(R.id.articleDetailPageContentLayout);
		List<OEntity> list = null;
		try {
			list = new DEFeed().execute("NewsBulletins").get();
		} catch (Exception e) {
			WebView web = new WebView(this);			
			layout.addView(web, new LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT));
			web.loadData(e.getMessage(), "text/html", null);			
		}
